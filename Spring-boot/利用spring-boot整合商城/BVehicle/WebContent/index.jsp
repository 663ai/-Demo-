...
<body>
					...
					<div class="pc-indexPage-nav-menu fl" id="float-nav-menu">
						<ul class="nav-list" id="more-nav-list">
							<li class="nav-li nav-li-first" >
								<dl class="nav-wrap">
									<dt>
										<a  class="catagory"   href="check.jsp">上衣</a>
									</dt>
									<dd>
										<span>
											<a  class="first"   href="check.jsp">初冬上新</a><ins></ins>
											<a  href="list.jsp">毛呢外套</a><ins></ins>
											<a href="list.jsp">棉服</a>
										</span>
									</dd>
								</dl>
								<div data-nav="nav-menu"class="nav-more"style="display:none;">
									<h2>
										<a   href="list.jsp">上衣</a>
									</h2>
									<dl class="nav-more-wrap">
										<dt>
											<a   href="list.jsp">当季热卖</a>
										</dt>
										<dd class="more-list">
											<a  href="list.jsp" style="color:#FF0077">时尚卫衣</a>
											<a  href="list.jsp" style="color:#FF0077">精致套装</a>
											<a  href="list.jsp" style="color:#999">针织衫</a>
											<a  href="list.jsp" style="color:#999">气质风衣</a>
											<a  href="list.jsp" style="color:#999">衬衫</a>
											<a    href="list.jsp" style="color:#999">棒球外套</a>
											<a    href="list.jsp" style="color:#999">长袖T恤</a>
											<a  href="list.jsp" style="color:#999">牛仔外套</a>
										</dd>
									</dl>
									<dl class="nav-more-wrap">
										<dt>
	...
	<div class="header-banner clearfix"id="header-banner"style="background:#FF9003;">
		<div class="banner-wrap clearfix">
				...
				<div class="pc-indexPage-nav-menu fl" id="banner-nav-menu">
					<ul class="nav-list" id="more-banner-list">
						<li class="nav-li nav-li-first" >
							<dl class="nav-wrap">
								<dt>
									<a  class="catagory" href="list.jsp">上衣</a>
								</dt>
								<dd>
									<span>
										<a  class="first"  href="list.jsp">初冬上新</a>
										<ins></ins>
										<a  href="list.jsp">毛呢外套</a>
										<ins></ins>
										<a href="list.jsp">棉服</a>
									</span>
								</dd>
			...
			<c:choose>
				<c:when test="${requestScope.manager} eq null">
					<a  href="#" class="avatar"></a>
					<div class="welcome">
						<p class="txt">菇凉好!</p>
						<p class="name">欢迎来逛蘑菇街~</p>
					</div>
	
					<!-- 未登录 -->
					<a  href="login.jsp"  style="display: block; ">
						<span style="display: block; text-align: center; margin-top: 20px;">登录</span>
					</a>
					<div class="register" style="display: block;">
						<a href="login.jsp">免费注册</a>
						<a  href="#">开小店</a>
					</div>
				</c:when>
				<c:otherwise>
					...
					<a  href="#"  style="display: block; ">
						<div style=" background:#FDF93E; height: 50px;">
							<span style=" line-height: 50px;display: block; text-align: center; color:#435AFC;">${requestScope.manager}</span>
						</div>
					</a>
					<a  href="#"  style="display: block; ">
						<span style="display: block; text-align: center; margin-top: 20px;">开小店</span>
					</a>
				</c:otherwise>
			</c:choose>
